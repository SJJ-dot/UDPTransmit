...
public class msg_param_value extends MAVLinkMessage {
    ...
    public void unpack(MAVLinkPayload payload) {
        ...
        param_value_int = payload.getInt();

        this.param_value = Float.intBitsToFloat(param_value_int);
    ...
    public String toString() {
        double param_value;
        if (param_type == MAV_PARAM_TYPE.MAV_PARAM_TYPE_INT32) {
            param_value = this.param_value_int;
        } else {
            param_value = this.param_value;
        }

        return "MAVLINK_MSG_ID_PARAM_VALUE -" + " param_id:" + getParam_Id() + " param_value:" + param_value + " param_count:" + param_count + " param_index:" + param_index + " param_type:" + param_type + "";
    }
}
