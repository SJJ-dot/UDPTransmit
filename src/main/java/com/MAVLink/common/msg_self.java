...
public class msg_self extends MAVLinkMessage {
    ...
    public static final int ONE_KEY_SUCCESS = 0;
...
//        packet.payload.putByte(confirmation);
    ...
    public void unpack(MAVLinkPayload payload) {
        try {
            ...
            double lng = payload.getInt() * 0.0000001;
            double lat = payload.getInt() * 0.0000001;
    ...
    public static enum SELF_INSPECTION_ITEM {
        BARO(1 << 1, "气压计"),
        RC(1 << 2, "遥控器"),
        COMPASS(1 << 3, "磁传感器"),
        INS(1 << 4, "惯导"),
